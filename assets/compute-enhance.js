(()=>{
  ...
  function inject(){
    ...
    card.innerHTML='<div style="font-size:30px">◫</div><div><div class="eyebrow">Interactive compute lesson</div><b style="display:block;font-size:16px;margin-top:2px">VM Availability & Scaling Simulator</b><span style="display:block;color:var(--muted);font-size:12px;margin-top:3px">เทียบ Availability Set / Zones / VMSS แล้วจำลอง rack failure, zone outage และ traffic spike</span></div><span class="btn primary" style="pointer-events:none">Open Lab →</span>';
